# checks albedo values given SH files - creates csv map files for albedo and thermal
...
if __name__ == "__main__":
    ...
    alboutfile = open( filepath+"albedoout30.csv", 'w' )
    alboutfile.write('Albedo Map' + '\n' + '\n')

    thmoutfile = open( filepath+"thermalout30.csv", 'w' )
    ...
    for lat in range(maxlat, minlat, -steplat):
