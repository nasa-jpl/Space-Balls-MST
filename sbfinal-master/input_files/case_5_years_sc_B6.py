...
SC_KEP_0 = { 'a': 6378.14 + 800, #+ 894,      # 6878.14, (500km) #7378.14, #1000 km mean alt  #semi-maj axis in km
             'e': 0.0,          # 0.001, # eccentricity
             'i': 98,         # 97.40,(500 km for SS orbit) #100.66,(1250 km) #99.48,(1000 km) #58.5064, #inclination
             'o': 300.0,         # for 21Mar to zero longitude: 358.88, #not RAAN here but long. of node: 180.0 deg = 12 pm MLTAN, 90.0 = 6am
             'u': 0.0,          # Arg of perigee
             'theta': 300.0,     # true anomaly
           } 
...
FORCE_SETTINGS = { 
        ...
        'erp_sh_files': "historic", #"historic",
        'erp_sh_Nmax': 45,
        'aero_force' : True,
