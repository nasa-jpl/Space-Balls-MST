...
SC_KEP_0 = { 'a': 7178.14,      # 6878.14, (500km) #7378.14, #1000 km mean alt  #semi-maj axis in km
             'e': 0.0,          # 0.001, # eccentricity
             'i': 98.5,         # 97.40,(500 km for SS orbit) #100.66,(1250 km) #99.48,(1000 km) #58.5064, #inclination
...
FORCE_SETTINGS = { 
        ...
        'srp_force' : True,
        'erp_forces': ['Thermal'],   # 'Albedo', 'Thermal'
        'erp_sh_files': "historic",
        'erp_sh_Nmax': 45,
        'aero_force' : True,
        'WGS84_albedo_shape': False  # True does not work (MONTE incompatibility) 
...
OUTPUT_SETTINGS = {
    ...
    'save_ERP_mesh_history': True,
    'matlab_output' : ['r_sun_hist', 'R_ijk2ric']      # available options: ['visibility_cap_hist', 'r_sun_hist', 'R_ijk2ric']
}