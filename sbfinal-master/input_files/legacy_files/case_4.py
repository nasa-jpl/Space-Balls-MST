...
SC_INPUT = {
        ...
        'name': "Spaceball",
        'mass': 90.0,   # kg
        'shape': "sphere50", # choose name of shape type: "icosahedron", "buckyball", "cylinder", "plate", "sphere", "cube", or "sphere128"  
...
OUTPUT_SETTINGS = {
    ...
    'matlab_output' : []      # available options: ['visibility_cap_hist', 'r_sun_hist', 'R_ijk2ric']
}